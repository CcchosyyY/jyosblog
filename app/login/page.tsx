      ...
      <div className="relative w-full max-w-[480px] mx-4 p-10 sm:p-12 bg-card border border-card-border rounded-2xl flex flex-col items-center gap-8 shadow-lg shadow-black/5">
        ...
        <div className="w-full flex flex-col gap-3.5">
          <button
            ...
            className="w-full flex items-center justify-center gap-3 py-4 px-5 rounded-xl bg-surface border border-card-border text-foreground hover:bg-foreground/5 hover:border-foreground/15 transition-all duration-200 text-body-lg font-medium disabled:opacity-50 disabled:cursor-not-allowed"
          >
