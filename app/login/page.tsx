  ...
  return (
    <div className="min-h-[calc(100vh-56px)] flex items-center justify-center bg-background relative overflow-hidden">
      ...
      <div className="relative w-full max-w-[480px] mx-4 p-10 sm:p-12 bg-card border border-card-border rounded-2xl flex flex-col items-center gap-8 shadow-lg shadow-black/5">
        ...
        {/* Error */}
        {error && (
          <div className="w-full flex items-center gap-2.5 bg-primary/10 border border-primary/20 text-primary p-3.5 rounded-xl text-[13px] font-medium">
            <svg
        ...
        <div className="w-full flex flex-col gap-3.5">
          <button
            ...
            className="w-full flex items-center justify-center gap-3 py-4 px-5 rounded-xl bg-surface border border-card-border text-foreground hover:bg-card-border/30 hover:border-muted/30 transition-all duration-200 text-[15px] font-medium disabled:opacity-50 disabled:cursor-not-allowed"
          >
